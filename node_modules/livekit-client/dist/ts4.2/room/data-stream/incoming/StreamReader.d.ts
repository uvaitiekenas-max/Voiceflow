...
declare abstract class BaseStreamReader<T extends BaseStreamInfo> {
    ...
    constructor(info: T, stream: ReadableStream<DataStream_Chunk>, totalByteSize?: number, outOfBandFailureRejectingFuture?: Future<never, Error>);
...
export declare class TextStreamReader extends BaseStreamReader<TextStreamInfo> {
     ...
     */
    constructor(info: TextStreamInfo, stream: ReadableStream<DataStream_Chunk>, totalChunkCount?: number, outOfBandFailureRejectingFuture?: Future<never, Error>);
    protected handleChunkReceived(chunk: DataStream_Chunk): void;
    /**
