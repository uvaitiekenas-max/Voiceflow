...
# Let's add the angles to Kunas AE schema
# Currently Kunas AE starts around '<h3>3.1. Kūno AE pusiausvyra</h3>'
# I will use replace on the string just after '<!-- Moments -->'
kunas_ae_angles = """
    <!-- Angles -->
